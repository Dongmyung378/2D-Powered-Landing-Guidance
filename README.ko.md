...
선택한 이득은 `Kp=0.08`, `Ki=0.001`, `Kd=0.01`입니다. 고도 80-120 m, 수직속도 -25~-15 m/s, 질량 950-1000 kg 범위에서 고정 seed로 100개 초기조건을 생성했습니다. 9일차는 수직 전용 단계이므로 수평 위치·속도와 자세·각속도는 0으로 고정했습니다.
...
모든 표본이 접지 속도 2 m/s 이하였으며 로드맵 완료 기준인 안전 착륙률 80%를 넘었습니다.
...
9일차 목표값은 고도가 낮아질수록 허용 하강속도가 작아지도록 정의합니다.
