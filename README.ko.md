...
| 현재 제어기 | 수직 suicide-burn 기준선 |
| 실행 환경 | Python 3.12.7 |

현재 저장소에는 검증된 시뮬레이션 환경과 첫 번째 비학습 착륙 기준선이 구현되어 있습니다. PID, 최적제어, Behavior Cloning, DAgger, 외란과 Monte Carlo 평가는 이후 로드맵에서 진행합니다.
...
- Suicide-burn 제어기는 수직 전용이며 수평 위치와 자세를 보정하지 않습니다.
